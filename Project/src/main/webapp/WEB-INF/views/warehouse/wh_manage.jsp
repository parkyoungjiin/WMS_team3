			...
			$(function() {
					...
					.done(function(wharealist) { // 요청 성공 시
						for(let list of wharealist) {
							...
							+"<span id='test"+list.wh_area_cd+"'><a href='javascript:void(0)' onclick='stocklist_area("+list.wh_cd+","+list.wh_area_cd+",0)'>창고 지역 :"+list.wh_area + "</a></span></td>"
