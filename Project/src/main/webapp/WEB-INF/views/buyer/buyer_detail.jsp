	...
	<jsp:include page="../inc/side.jsp"></jsp:include>
		...
		<form action="BuyerModifyPro" method="post">
			<table border="1">
				<tr>
					<td>거래처코드</td>
					<td><input type="text" name="business_no" required="required" value="${buyer.business_no }"></td>
				</tr>
				<tr>
					<td>상호</td>
					<td><input type="text" name="cust_name" required="required" value="${buyer.cust_name }"></td>
				</tr>
				<tr>
					<td>거래처 코드 구분</td>
				...
				<tr>
					<td>업태</td>
					<td><input type="text" name="uptae" value="${buyer.uptae }"></td>
				</tr>
				<tr>
					<td>종목</td>
					<td><input type="text" name="jongmok" value="${buyer.jongmok }"></td>
				</tr>
				<tr>
					<td>대표 전화번호</td>
					<td><input type="text" name="tel" value="${buyer.tel }"></td>
				</tr>
				<tr>
					<td>팩스</td>
				...
				<tr>
					<td>모바일</td>
					<td><input type="text" name="mobile_no" value="${buyer.mobile_no }"></td>
				</tr>
				<tr>
					<td>이메일</td>
					<td><input type="text" name="email" value="${buyer.email }"></td>
				</tr>
				<tr>
					<td>우편번호</td>
					<td><input type="text" name="post_no" value="${buyer.post_no }"></td>
				</tr>
				<tr>
					...
					<td>주소</td>
					<td><input type="text" name="addr1" value="${buyer.addr }"></td>
					<td>상세주소</td>
				...
				<tr>
					...
					<td>담당자 전화번호</td>
					<td><input type="text" name="man_tel" value="${buyer.man_tel }"></td>
					<td>담당자 이메일</td>
					<td><input type="text" name="man_email" value="${buyer.man_email }"></td>
				</tr>
				<tr>
					<td>적요</td>
